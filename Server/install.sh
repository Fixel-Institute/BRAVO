...
$SCRIPT_DIR/venv/bin/pip3 install django djangorestframework numpy scipy pandas spectrum mysqlclient requests websocket-client scikit-learn cryptography
