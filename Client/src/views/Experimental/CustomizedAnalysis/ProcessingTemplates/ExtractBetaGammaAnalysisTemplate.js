...
const ExtractBetaGammaAnalysisTemplate = ({availableRecordings, setConfiguration}) => {
  const [options, setOptions] = useState({
    ...
    output: "Beta/Gamma Features Output"
  });
...
export default ExtractBetaGammaAnalysisTemplate;